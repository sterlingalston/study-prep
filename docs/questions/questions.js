...
// Questions extracted directly from snowcore notes PDF
...
const questions = [
    // Domain 1: Architecture - Sample Questions
    {
        domain: 'architecture',
        type: 'multiple',
        question: 'How often does Snowflake aim to release new features using their release process?',
        options: [
            'Daily',
            'Weekly',
            'Monthly',
    ...
    },
    {
        domain: 'architecture',
        type: 'multiple',
        question: 'How many phases does query pruning have?',
        options: [
            'One phase',
            'Two phases',
            'Three phases',
